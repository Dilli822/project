<section id="about" class="bg-white dark:bg-gray-900">
    ...
    <div class="container px-6 pb-8 mx-auto">
        ...
        <div class="grid gap-8 mt-8 justify-items-center sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 ">
            <x-team-card name="Darshan Shakya" title="Frontend Developer"
                src="{{ asset('images/darshan..jpg') }}"></x-team-card>
            <x-team-card name="Sanjiv Rai" title="Frontend Developer" src="{{ asset('images/sanjiv.jpg') }}"></x-team-card>
            <x-team-card name="Santosh Rai" title="Fullstack Developer"
                src="{{ asset('images/santosh.jpg') }}"></x-team-card>
        </div>
    </div>
</section>
